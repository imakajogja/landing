    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <div class="imaka-drawer mdl-layout__drawer">
        <nav class="mdl-navigation">
          ...
          <a class="mdl-navigation__link" href="http://amikom.ac.id"><i class="material-icons">arrow_forward</i>Universitas Amikom Yogyakarta</a>
      ...
      <div class="imaka-content mdl-layout__content">
        ...
        <section class="discover-us">
          <div class="discover-us-container">
            <div class="imakard-team mdl-grid">
              <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-tablet mdl-cell--12-col-phone mdl-card address">
                <div class="addess">
                ...
                <div class="bottom">
                  <a href="https://facebook.com/ImakaAmikom">Facebook</a>/
                  <a href="https://instagram.com/imakajogja">Instagram</a>/
                  <a href="https://twitter.com/imakajogja">Twitter</a>
                </div>
              </div>
          </div>
        </section>
        <footer class="imaka-footer">
          <div class="mdl-mega-footer--middle-section">
            <p>© 2019 IMAKA, Crafted with 🍩 by Yanuar Aditia</p>
          </div>
